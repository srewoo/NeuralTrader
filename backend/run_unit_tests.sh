...
# NeuralTrader - Unit Tests Runner
...
echo -e "${BLUE}========================================"
echo -e "  NeuralTrader - Unit Tests"
echo -e "========================================${NC}"
echo ""
...
./venv/bin/pytest tests/unit/ \
    ...
    --tb=short \
    --cov=. \
    --cov-report=html:reports/unit_coverage_${TIMESTAMP} \
    --cov-report=term-missing \
    --html=reports/unit_report_${TIMESTAMP}.html \
    --self-contained-html \
    2>&1 | tee reports/unit_output_${TIMESTAMP}.log
...
ln -sf "unit_report_${TIMESTAMP}.html" reports/unit_report_latest.html
